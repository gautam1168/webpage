...
$(document).ready(function()
{
	...
	*/
	...
	function initSearch()
	{
		...
		$(".search_form_list input.datepicker").datepicker()
		$('#guests').popover()
		$('#guests').on('hide.bs.popover', function() {
			let numadults = $("input#numadults").val()
			let numchildren = $("input#numchildren").val()
			$("#guests").find("span").text("Adults: " + numadults + " Children: " + numchildren)
		})
	}
